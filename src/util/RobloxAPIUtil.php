...
class RobloxAPIUtil {
		...
		if ( str_ends_with( strtolower( $expectedType ), 'id' ) ) {
			...
			switch ( $expectedType ) {
				...
				case 'Username':
					...
					break;
				case 'Boolean':
					if ( !in_array( strtolower( $arg ), [ 'true', 'false' ], true ) ) {
	...
	public static function assertArgAllowed( Config $config, string $expectedType, string $arg ): void {
		...
		// ToDo check whether supplying e.g. ints as allowed values is a problem
