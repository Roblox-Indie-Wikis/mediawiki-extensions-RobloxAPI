...
7. Create a branch from master with the version number as the branch name, e.g. `ver/1.1.0`. For minor releases, you
   should update the branch for the last minor version instead.
